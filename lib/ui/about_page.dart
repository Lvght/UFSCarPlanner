        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10,),
              Text("Matheus Ramos @BCC_019", style: TextStyle(fontSize: 18), textAlign: TextAlign.center,),
              Text("Vinicius Quaresma da Luz @BCC_019", style: TextStyle(fontSize: 18), textAlign: TextAlign.center,),
              SizedBox(height: 30,),
